...
CY_ISR(custom_BUTTON_PRESS_ISR)
{
    ...
    if (flag_fastclick)
    {
        ...
        {
            // Initialisation of the flag variables to the initial condition
...
CY_ISR(custom_BUTTON_REL_ISR)
{
    ...
    {
        // Fast click condition --> differentiation of the DOUBLE CLICK and the SINGLE CLICK
        flag_fastclick = 1;
    ...
    if(flag_shortdistance && flag_fastclick)
    {
        //****** DOUBLE CLICK CONDITION ******//
        flag_doubleclick = 1;
